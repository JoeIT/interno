 ...
 * File:        function.ajax_update_combo.php
 *
...
function smarty_function_ajax_update_combo($params, &$smarty)
{
  ...
  return 'SmartyAjax.update_combo(\'' . $update_id . '\', \'' . $url .
    '\', \'' . $method . '\', \'' . $parameters . '\', ' . $callback . ', ' . $params_func . '); return false;';
