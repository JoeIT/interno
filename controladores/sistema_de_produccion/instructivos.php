		...
		if ($funcion == "buscar_instructivo") {
			...
			if ($funcion == "registrar") {
				...
				if ($funcion == "insertar") {
					...
					if (trim($_FILES['grafico']['name']) == "" && trim($_POST['nuevo']) == "" && !isset($_POST['escogido'])) {
					...
					*/
					...
					if ($error != "") {
						...
						if ($_FILES['grafico']['name'] != "") {
							// nuevo instructivo
							$nombre_archivo = $_FILES['grafico']['name'];
							$nombre_archivo_original = $_FILES['grafico']['name'];
							$tipo_archivo = $_FILES['grafico']['type'];
							$tamano_archivo = $_FILES['grafico']['size'];
							...
							if (!(strpos($tipo_archivo, "pdf"))) {
								...
								move_uploaded_file($_FILES['grafico']['tmp_name'], $nombre_archivo);
