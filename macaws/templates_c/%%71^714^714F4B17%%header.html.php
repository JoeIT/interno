...
<table width="100%" border="0" cellpadding="1" cellspacing="1" class="tableblueSB">
	...
	<tbody >
		<tr>
	      ...
	      Ventas</a></td>
		  <td width="80" align="center" class="header-table"><a href="seleccionarGestion.php" class="blue-small-link"><img src="css/imagenes/periodo.jpg" width="20" height="20" border="0" /><br/>
	      Periodos</a></td>
		<td width="80" align="center" class="header-table"><a href="adminGestion.php" class="blue-small-link"><img src="css/imagenes/gestiones.jpg" width="20" height="20" border="0" /><br/>
		  Gestiones</a></td>
          ...
          <!--enlace para las sucursales-->
          <td width="80" align="center" class="header-table"><a href="sucursal.php" class="blue-small-link"><img src="css/imagenes/guia.png" width="20" height="20" border="0" /><br/>Sucursales</a></td>
          <!--fin enlace sucursales-->
