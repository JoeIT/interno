<?php /* Smarty version 2.6.18, created on 2013-10-08 15:17:02
         compiled from compra.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'ajax_call', 'compra.html', 145, false),)), $this); ?>
...
/<?php echo $this->_tpl_vars['gestionperiodo']['gestion']; ?>
    ...
    <tr>
	  ...
	  <?php if ($this->_tpl_vars['reg_ok'] != null): ?>
		...
		<tr>
		<td align="center" width="700" >Se registro la compra con exito, Nro. de Factura: <?php echo $this->_tpl_vars['reg_ok']; ?>
 </td>
		</tr>
		</table>
	  <?php endif; ?>
...
" 
    ...
    <tr>
      ...
      <td align="left">	  
	  <input name="rsocial" id="rsocial" type="text" value="<?php echo $this->_tpl_vars['val']['rsocial']; ?>
" size="70" maxlength="50" class="text3" 
    ...
    <tr>
      ...
      <td align="left">
	  <input name="alfanumerico" type="text" class="text3" id="alfanumerico" value="<?php echo $this->_tpl_vars['val']['alfanumerico']; ?>
" size="25" maxlength="25" onkeypress="return enter_handle(this, event, 1, 1)"/>
	  <label id="errorlabel"><?php echo $this->_tpl_vars['error']['alfanumerico']; ?>
</label></td>
	  </td>
    </tr>
    <tr>
...
" size="25" maxlength="25" onkeypress="return enter_handle(this, event, 1, 1)"/>
    ...
    <tr>
      ...
      <td align="left"><input name="control" type="text" class="text3" id="control" value="<?php echo $this->_tpl_vars['val']['control']; ?>
" size="25" maxlength="25" onkeypress="return enter_handle(this, event, 1, 1)"/>
...
)" value="<?php echo $this->_tpl_vars['val']['totalfact']; ?>
...
" size="13" maxlength="10" onkeypress="return enter_handle(this, event, 6, 1)"/>
    ...
    <tr>
      ...
      <td align="left">
	  <input name="totalexento" type="text" class="text3" id="totalexento" value="<?php echo $this->_tpl_vars['val']['totalexento']; ?>
" size="13" maxlength="13" readonly="true" /></td>
    </tr>
    <tr>
      <td align="right" class="styleText">Impuesto Cr&eacute;dito Fiscal:</td>
      <td align="left">
	  <input name="iva" type="text" class="text3" id="iva" value="<?php echo $this->_tpl_vars['val']['iva']; ?>
...
" />	  </td>
    ...
    <tr>
      ...
      <?php if ($this->_tpl_vars['id'] == 1): ?>
      <input type="button" name="cancelar" value="Cancelar" onclick="location='/sistema/macaws/lcv.php'" class="text7"/><br />
     <?php else: ?>	
     <input type="button" name="cancelar" value="Cancelar" onclick="location='/sistema/macaws/generalcv.php'" class="text7"/> <?php endif; ?>  </td>
    </tr>
  </table>
</form>
<?php else: ?>
