...
if(isset($_SESSION['usuario_id']))
{
	...
	else
	{
		...
		if(!$compra->validarFactura($_POST['factura'],$_POST['autorizacion'],$_POST['nit']))
		{
			...
			$compra->insert_Compra($fecha,$_POST['nit'],$_POST['rsocial'],$_POST['factura'],$_POST['autorizacion'],$_POST['control'],$_POST['totalfact'],$_POST['ice'],$_POST['exento'],$_POST['totalexento'],$_POST['iva'],$_POST['cod_pg'],$_POST['alfanumerico'],$_SESSION['usuario_id'],$_SESSION['sucursal_id']);
