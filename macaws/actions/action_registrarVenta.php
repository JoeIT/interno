...
if(isset($_SESSION['usuario_id']))
{
	...
	else
	{
		...
		if(!$venta->validarFactura($_POST['factura'],$_POST['autorizacion'],$_POST['nit']))
		{
			...
			$venta->insert_Venta($fecha,$_POST['nit'],$_POST['rsocial'],$_POST['factura'],$_POST['autorizacion'],$_POST['control'],$_POST['totalfact'],$_POST['ice'],$_POST['exento'],$_POST['totalexento'],$_POST['iva'],$_POST['cod_pg'],$_SESSION['usuario_id'],$_POST['tipovent'],$_SESSION['sucursal_id']);
