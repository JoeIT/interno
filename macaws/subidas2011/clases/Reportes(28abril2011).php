...
class Reportes {
	...
	function buscar_Compras($texto_search,$criterio,$gestion,$periodo,$fec)
	{
		$data = null;
		$i=0;
		$text_gestion = "";
	...
	function buscar_Ventas($texto_search,$criterio,$gestion,$periodo,$fec)
	{
		$data = null;
		$i=0;
		$text_gestion = "";
	...
	function buscar_ComprasReporte($texto_search,$criterio,$gestion,$periodo,$fec,$ini,$fin)
	{
		$data = null;
		$i=0;
	...
	function buscar_VentasReportes($texto_search,$criterio,$gestion,$periodo,$fec,$ini,$fin,$tipoventa=1)
	{
		$data = null;
		$i=0;
		$totalfact = 0;$totalice = 0;
	...
	function ventaTotalesGenerales($gestion,$periodo,$tipoventa=1)
	{
		$data = null;
		$totalfact = 0;$totalice = 0;
		$totalexen = 0;$totalimp = 0;
	...
	function calculatePagesReport($intervalo,$tipo,$gestion,$periodo,$tipovc=1)
	{
		$data = 0;
		$sql=null;
		$paginas = null;
		...
		if($tipo==1)
		{
			for($i = 0; $i<($data); $i++)
			{
				$valor ="tiporep=".$tipo."&iniInt=".($i*$intervalo)."&endInt=".$intervalo."&gestion=".$gestion."&periodo=".$periodo."&pag=".($i+1)."&ttl=".$data."&tvent=".$tipovc;
		...
		else
		{
			for($i = 0; $i<($data); $i++)
			{
				$valor ="tiporep=".$tipo."&iniInt=".($i*$intervalo)."&endInt=".$intervalo."&gestion=".$gestion."&periodo=".$periodo."&pag=".($i+1)."&ttl=".$data."&alfa=".$tipovc;
				$paginas[$i]['indice']=$valor;
			}
		}
		return $paginas;
	...
	function buscar_ComprasAlfanumericoReporte($texto_search,$criterio,$gestion,$periodo,$fec,$ini,$fin)
	{
		$data = null;
		$i=0;
		$totalfact = 0;$totalice = 0;
	...
	function reporteDaVinci($tipo,$periodo,$gestion)
	{
		$data=null;
		$sql = "";
		if ($periodo<10)
		...
		$sql = "select tc.nit, tc.razon_social, tc.factura, tc.autorizacion, 
				...
				tc.importe, tc.credito_fiscal, tc.codigo_control 
