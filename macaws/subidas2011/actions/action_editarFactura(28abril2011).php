		...
		else
		{
			...
			{				
				if(strcasecmp($_POST['tipo'],"Venta")==0)
				{
					...
					$venta->updateVenta($fecha,$_POST['nit'],$_POST['razon_social'],$_POST['factura'],$_POST['autorizacion'],$_POST['codigo_control'],$_POST['total_facturado'],$_POST['ice'],$_POST['exento'],$_POST['importe'],$_POST['credito_fiscal'],$_POST['cod_pg'],$_SESSION['usuario_id'],$_POST['tipovent'],$_POST['codfac']);
				...
				{
					$fecha ="".$_POST['gestion']."-".$_POST['periodo']."-".$_POST['fecha'];
					$compra->updateCompra($fecha,$_POST['nit'],$_POST['razon_social'],$_POST['factura'],$_POST['autorizacion'],$_POST['codigo_control'],$_POST['total_facturado'],$_POST['ice'],$_POST['exento'],$_POST['importe'],$_POST['credito_fiscal'],$_POST['cod_pg'],$_SESSION['usuario_id'],$_POST['codfac']);
