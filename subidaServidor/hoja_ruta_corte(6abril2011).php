       ...
       if ($_GET['funcion'] == "validar") 
         { 
			 ...
			 {  
                   ...
                   {
                    $ver=$hoja_ruta_corte->ingresar_cueroutilizado($valor,$_POST['orden_id'],$_POST['fecha_corte'][$indice],$_POST['maquinista_id'][$indice],$_POST['cuero_utilizado'][$indice],$_POST['retaceria'][$indice],$_POST['retazos'][$indice],$_POST['desperdicio'][$indice],$_POST['cuero_utilizado_pies'][$indice]);      
                   }                 
			 }
