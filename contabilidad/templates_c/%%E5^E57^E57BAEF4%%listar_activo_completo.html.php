<?php /* Smarty version 2.6.18, created on 2009-06-29 11:47:47
         compiled from listar_activo_completo.html */ ?>
...
"><?php echo $this->_tpl_vars['item']['localizacion']; ?>
...
"><?php echo $this->_tpl_vars['item']['grupo']; ?>
-<?php echo $this->_tpl_vars['item']['descripcion']; ?>
</option>
...
-->
		...
		<a href="../controladores/modificar_activo_completo.php?funcion=detalle&elegido=<?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['act_id']; ?>
 " name="<?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['act_id']; ?>
" id="<?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['act_id']; ?>
"><?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['numero']; ?>
</a>
...
<?php endif; ?></td>
                   ...
                   <td>
				   <a href="javascript:ventanafotografiasactivo ('activo.php?popup=true&&opcion=registrar_foto&&numero=<?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['numero']; ?>
-<?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['act_id']; ?>
')"> Ingresar Foto</a></td>
    </tr>
    <?php endfor; endif; ?>
  <tr>
