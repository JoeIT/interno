<?php /* Smarty version 2.6.18, created on 2009-04-24 09:47:32
         compiled from transferencia.html */ ?>
...
<form name="orden" method="get" action="../controladores/activo.php"  align="center">
  <table border="0" align="center" cellpadding="0" cellspacing="3" width="35%">
    <tr>
      <th>Reporte de Transferencia </th>
    </tr>
  </table>
...
"><?php echo $this->_tpl_vars['item']['descripcion']; ?>
  ...
  <center><p><input type="submit" value="Buscar Activo" name="transferencia" class="enviar" onmouseover="this.className='boton'" onmouseout="this.className='enviar'">
  </p></center>
</form>
...
-->
		...
		<a href="../controladores/transferencia.php?funcion=detalle&elegido=<?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['act_id']; ?>
 " name="<?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['act_id']; ?>
" id="<?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['act_id']; ?>
"><?php echo $this->_tpl_vars['lista1'][$this->_sections['ind']['index']]['numero']; ?>
</a>
