<?php /* Smarty version 2.6.18, created on 2009-11-16 08:47:42
         compiled from resumen_kardex.html */ ?>
...
<div id="installOK" align="center" style="vertical-align:top;" >
  ...
  <table height="66" border="1" align="center" cellpadding="0" cellspacing="0" style="border-color:#E9E9E9;height:1.4cm;margin:0cm;width:20.3cm; clear:both;">
	  <tr>
		<td  class="contenido1" style="width:2.7cm;" align="center"><span class="contenido1" style="width:2.7cm;"><img src="../../templates/imagenes/logo-macaws2.jpg" align="middle" style="height:1.4cm;width:1.8cm;"/></span></td>
		<td class="contenido1" style="font-size:13px;font-weight:bold;width:8.9cm" align="center"><p>RESUMEN ACTIVOS FIJOS</p>
		  <p><br/>
          </p></td>
  ...
  <?php $_from = $this->_tpl_vars['res_kardex']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['nombre'] => $this->_tpl_vars['val']):
?>
     <div style=" font-size:12px" align="left"><?php echo $this->_tpl_vars['nombre']; ?>
</div> 
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>&nbsp;</td>
    <td>--------------
	<div style="font-size:10px"><?php echo $this->_tpl_vars['asignado']; ?>
</div>
	<div style="font-size:10px">Firma</div></td>
    <td>	</td>
  </tr>
</table>
</tr>
