...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		if (buttons == true) {
			...
			document.writeln('				<option value="<p>">Parrafo &lt;p&gt;</option>');
			document.writeln('				<option value="<h1>">Encabezado 1 &lt;h1&gt;</option>');
			document.writeln('				<option value="<h2>">Encabezado 2 &lt;h2&gt;</option>');
			document.writeln('				<option value="<h3>">Encabezado 3 &lt;h3&gt;</option>');
			document.writeln('				<option value="<h4>">Encabezado 4 &lt;h4&gt;</option>');
			document.writeln('				<option value="<h5>">Encabezado 5 &lt;h5&gt;</option>');
			document.writeln('				<option value="<h6>">Encabezado 6 &lt;h6&gt;</option>');
			document.writeln('				<option value="<address>">Citación &lt;ADDR&gt;</option>');
	...
	//		document.writeln('		<td><img class="rteVertSep" src="' + imagesPath + 'blackdot.gif" width="1" height="20" border="0" alt=""></td>');
		...
		if (!readOnly) document.writeln('<span style="display:none;"><br /><input type="checkbox" id="chkSrc' + rte + '" onclick="toggleHTMLSrc(\'' + rte + '\');" />&nbsp;Ver codigo</span>');
