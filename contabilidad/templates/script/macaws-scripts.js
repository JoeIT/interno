...
function ventanaSecundaria1 (URL) {
	window.open(URL,"ventana1","width=500, height=500, scrollbars=no, menubar=no, location=no, resizable=no")
}
function ventanafotografiasactivo (URL) {
	window.open(URL,"ventana1","width=700, height=700, scrollbars=no, menubar=no, location=no, resizable=no")
}
